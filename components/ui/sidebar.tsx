...
>(
  (
    { defaultOpen = true, open: openProp, onOpenChange: setOpenProp, style, children, ...props },
    ref
  ) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent
